...
router.put("/update_status",authenticatedUser.isAuthenticated, authenticatedUser.isAuthorized(["DOCTOR", "ADMIN"]), patientController.updateActiveAfterRegister);
...
router.get("/find_patient_in_queue",authenticatedUser.isAuthenticated, authenticatedUser.isAuthorizedFinding(["DOCTOR", "ADMIN"]), patientController.findPatientsInQueue);
